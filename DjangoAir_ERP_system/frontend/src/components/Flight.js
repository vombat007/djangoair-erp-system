...
import SeatTypeOptions from './FlightDetails'; // Import the new component
...
const FlightsSearch = () => {
  ...
  return (
    <div>
      ...
      {showSeatTypeOptions && (
        <SeatTypeOptions flightId={selectedFlightId} setShowSeatTypeOptions={setShowSeatTypeOptions} />
      )}
    </div>
  );
};
